...
import wang.coisini.mybatis.session.*;
import wang.coisini.mybatis.session.defaults.DefaultSqlSession;
import wang.coisini.mybatis.test.dao.IActivityDao;
...
//         sqlSession.close();
    ...
    public void test_insert_select() throws IOException {
        ...
        activity.setActivityDesc("测试数据插入");
        activity.setCreator("xiaofuge");
        int res = sqlSession.insert("wang.coisini.mybatis.test.dao.IActivityDao.insert", activity);

        Object obj = sqlSession.selectOne("wang.coisini.mybatis.test.dao.IActivityDao.insert!selectKey");
